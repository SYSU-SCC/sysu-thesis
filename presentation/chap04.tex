...
\frame{
	...
	\begin{figure}
		\centering
		\includegraphics[width=.25\textwidth,height=.15\textwidth]{image/chap04/example/2007_000799.jpg}
		\includegraphics[width=.25\textwidth,height=.15\textwidth]{image/chap04/example/2007_002094.jpg}
		\includegraphics[width=.25\textwidth,height=.15\textwidth]{image/chap04/example/2007_004483.jpg}
		\includegraphics[width=.25\textwidth,height=.15\textwidth]{image/chap04/example/2007_003194.jpg}
...
\frame{
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			...
			\begin{figure}
				\centering
				\includegraphics[width=\textwidth]{image/chap04/combine.eps}
...
\frame{
	...
	\begin{figure}[h]
		...
		\makebox[0.15\textwidth]{\footnotesize 真值}
		\makebox[0.15\textwidth]{\tiny CNN+5LSTM}\\
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/2008_000673.jpg}
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/2008_000673.png}
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/p_2008_000673.png}
		\quad
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/2008_001580.jpg}
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/2008_001580.png}
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/p_2008_001580.png}
		\\
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/2007_002539.jpg}
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/2007_002539.png}
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/p_2007_002539.png}
		\quad
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/2007_008964.jpg}
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/2007_008964.png}
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/p_2007_008964.png}
		\\
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/2008_000763.jpg}
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/2008_000763.png}
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/p_2008_000763.png}
		\quad
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/2007_009088.jpg}
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/2007_009088.png}
		\includegraphics[width=0.15\textwidth]{image/chap04/result/error/p_2007_009088.png}
		\\
