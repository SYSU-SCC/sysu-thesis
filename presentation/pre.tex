...
\logo{\includegraphics[height=.08\linewidth]{../image/template/sysu-logo.pdf}} % 这个是每页都会出现的水印，可能会影响观感，自行决定放不放
...
\begin{frame}
    ...
    \begin{figure}
        \includegraphics[width=\linewidth]{../image/chap04/example/2007_004483.pdf}
        \caption{一}
    \end{figure}
