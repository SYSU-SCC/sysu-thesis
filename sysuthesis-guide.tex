...
\title{\cls{sysu-thesis} 使用说明}
\author{SYSU-SCC \and 1FCENdoge}
...
本模板 \cls{sysu-thesis} 是中山大学本科生和研究生学位论文的 \LaTeX{}
模板，代码架构借鉴中国科学技术大学学位论文 \LaTeX{}
模板魔改得到。

本模板依据《中山大学本科毕业论文（设计）写作与印制规范》以及 1FCENdoge 等人写
硕士/博士论文期间所使用的格式进行编写，主要由 
\href{https://github.com/huangjj27}{huangjj27}、\href{https://github.com/wu-kan}{wu-kan}、
\href{https://github.com/a20185}{a20185}、\href{https://github.com/1FCENdoge}{1FCENdoge} 
等人进行开发和维护。

新模板主要亮点：
\begin{itemize}
  \item 支持本科生和研究生模板一键切换
  \item 支持 GB/T 7714-2025 参考文献著录和标注样式（BibTeX 和 BibLaTeX）
\end{itemize}

下载地址：
\begin{itemize}
  \item 主要地址：\url{https://github.com/SYSU-SCC/sysu-thesis/releases}
\end{itemize}

用户在使用 \pkg{sysu-thesis} 模板前，应先了解学校对论文写作的要求。
如果在使用的过程中遇到问题，可以阅读
\href{https://github.com/ustctug/ustcthesis/wiki}{常见问题}，
或者在 \href{https://github.com/SYSU-SCC/sysu-thesis/issues}{GitHub Issues}
中反馈。
...
\begin{table}[htb]
  ...
  \begin{tabular}{lll}
    ...
    模板文件 & \file{sysuthesis.cls}     & 模板文件                     \\
             ...
             & \file{sysuthesis-*.bbx}   & BibLaTeX 参考文献样式      \\
             & \file{sysuthesis-*.cbx}   & BibLaTeX 文献引用样式      \\
             & \file{image/template/sysu*.pdf} & 校徽图片               \\
    \midrule
    ...
    示例文档 & \file{main.tex}           & 主文档                       \\
             ...
             & \file{code/}          & 需要添加到正文的计算机代码       \\
             & \file{docs/*.tex}     & 示例文档的各个章节           \\
             & \file{image/}           & 放置图片的目录               \\
             & \file{tables/}            & 放置表格的目录               \\
             & \file{reference.bib}       & \BibTeX{} 引用文献示例数据库 \\
    \midrule
...
本模板要求使用 TeX Live、MacTeX 或 MiKTeX 不低于 2020 年的发行版，
推荐安装最新的版本。
...
这里的样式是在 \href{https://ctan.org/pkg/biblatex-gb7714-2015}{biblatex-gb7714-2025}
的基础上进行了少量修改。
一些额外用法可以参考该宏包的文档。
...
\begin{latex}
  \usepackage[bibstyle=sysuthesis-numeric,
              citestyle=sysuthesis-inline]{biblatex}
\end{latex}
